...
END {
    ...
    # Output results
    printf "score_last_week,max_score_last_week,score_before_last_week,max_score_before_last_week,score_percentage_last_week,score_percentage_before_last_week,date\n"
